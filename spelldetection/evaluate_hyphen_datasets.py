...
def analyze_set(correct_set, *input_datasets, print_help = False):
    ...
    for dataset in range(len(input_sets)):
        ...
        output_frame.loc[dataset_names[dataset], '%ower'] = owe_calculated * 100

        swe_value = output_frame.loc[dataset_names[dataset], 'swe']
        swe_calculated = swe_value / correct_set_length
        output_frame.loc[dataset_names[dataset], '%swer'] = swe_calculated * 100
        ...
        output_frame.loc[dataset_names[dataset], '%oler'] = oler * 100
        output_frame.loc[dataset_names[dataset], '%sler'] = sler * 100
